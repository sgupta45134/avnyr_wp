...
$sections[] = array(
				...
				'desc' => '<p class="description">'.sprintf(__('Welcome to %s Theme Options panel. ','vibe'),THEME_FULL_NAME).'</p>
                                    <ol>
                                        <li>'.__('See Theme documentation : ','vibe').'<a href="https://wplms.io/" class="button">Official WPLMS Documentation</a></li> 
				...
				'fields' => array(
                       ...
                       array(
						...
						array(
							'id' => 'header_scripts',
							'type' => 'button_set',
							'title' => __('Custom Header [ Elementor / Divi]', 'vibe'), 
							'sub_desc' => __('Do not load Header Scripts' , 'vibe'),
							'desc' => __('Offload 80kb of header script and use custom header.', 'vibe'),
							'options' => array('0' => __('Disbaled','vibe'),'1' => __('Offload','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),
					)
				);
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
                        ...
                        'title' => __('Single Member Profile View', 'vibe').'[Legacy]',
					...
					array(
						'id' => 'single_activity_view',
                        'title' => __('Single Activity View', 'vibe'),
                        'sub_desc' => __('Single activity can be viewed by :', 'vibe'),
                        'desc' => __('Single activity visibility : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('All','vibe'),'1'=>__('Members only','vibe'),'2' => __('Teachers only','vibe'),'3' => __('Admins only','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),
...
$sections[] = array(
				...
				'fields' => array(
                        ...
                        'title' => __('Maintain accurate Student Count', 'vibe').'[Legacy]',
                        ...
                        'title' => __('Tab style course layout', 'vibe').'[Legacy]',
                        ...
                        'title' => __('Course status templates', 'vibe').'[Legacy]',
                        ...
                        'sub_desc' => __('Force instructors for Admin approval for new course', 'vibe').'[Coming up in v4]',
						...
						array(
						'id' => 'stats_visibility',
                        'title' => __('Leaderboard/Stats Visibility', 'vibe').'[Legacy]',
						...
						array(
						'id' => 'notes_style',
                        'title' => __('Notes and Discussion styles', 'vibe').'[Legacy]',
                        ...
                        'type' => 'radio_img',
						'options' => array(             
	                                        'course' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/thumb_2.png'),
											'course2' => array('Default' => __('Four Columns','vibe'), 'img' =>VIBE_URL.'/assets/images/thumb_8.png'),
											'course3' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/thumb_8.jpg'),
											'course4' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/thumb_9.jpg'),
											'course5' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/thumb_10.jpg'),
											'course7' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/course7.png'),
											'course8' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/course8.png'),
											'generic' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/generic.jpg'),
											'simple' => array('Default' => __('Four Columns','vibe'), 'img' => VIBE_URL.'/assets/images/simple.jpg'),
...
$sections[] = array(
				...
				'fields' => array(
					array(
                        ...
                        'sub_desc' => __('Required to fetch a list of Fonts from Google', 'vibe').'<a href="https://wplms.io/support/knowledge-base/google-api-key-for-font-manager-and-usage/">Learn how to get Google fonts API</a>'
						),
					 array(
						'id' => 'google_fonts',
...
$sections[] = array(
				...
				'fields' => array(
						...
						'id' => 'offload_scripts',
						'type' => 'button_set',
						'title' => __('BootStrap 4 & Offload scripts', 'vibe'), 
						'sub_desc' => __('Move to Bootstrap 4 & Offload 500-1500kb of legacy scripts.', 'vibe'),
						'desc' => __('Make sure you are fully on version 4 and you can offload legacy scripts which no longer required. No Jquery mode = Ultra fast loading site with No sliders, No Filterable blocks in site. Elementor editor stops loading. jQuery was released in 2006.', 'vibe'),
						'options' => array('' => __('No','vibe'),'1' => __('Yes','vibe'),'2' => __('No jQuery mode','vibe')),
						'std' => ''
						),
						array(
						'id' => 'offload_fonts',
						'type' => 'button_set',
						'title' => __('Offload FontIcon & Fontawesome 4.7', 'vibe'), 
						'sub_desc' => __('Save on 1500kb of legacy fonts.', 'vibe'),
						'desc' => __('On version 4 you can offload legacy fonts. Only works if Bootstrap4 & Offload scripts is enabled.', 'vibe'),
						'options' => array('' => __('No','vibe'),'1' => __('Yes','vibe')),
						'std' => ''
						),
						array(
						'id' => 'webp_svg',
						'type' => 'button_set',
						'title' => __('Disable WebP & SVG Support', 'vibe'), 
						'sub_desc' => __('Disable Support for Modern image types.', 'vibe'),
						'desc' => __('By default enabled in WPLMS.', 'vibe'),
						'options' => array('' => __('No','vibe'),'1' => __('Yes','vibe')),
						'std' => ''
						), 
						array(
						'id' => 'vibe_page_builder',
						'type' => 'button_set',
						'title' => __('Vibe Page Builder', 'vibe'), 
						'sub_desc' => __('Vibe Page Builder was removed in 4.0. It will not work with Bootstrap 4 and no jQuery mode.', 'vibe'),
						'desc' => 'Brng back the legacy Vibe Pgae builder',
						'options' => array('' => __('Disabled','vibe'),'1' => __('Bring it back ','vibe')),
						'std' => ''
						),                 
						array(
						'id' => 'site_lock',
...
$sections[] = array(
				...
				'desc' => '<p class="description">'.__('Switch between diffrent demos','vibe').'..</p>',
				'fields' => array(
                       array(
						'id' => 'demo_switch',
						'type' => 'demo_switcher',
                        'options' => array(
                        	'instructor' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/instructor.png')),  
                        	'demo_4_academy' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/demo4_academy.png')),
                        	'learningcenter' => array('Learning center' => __('Four Columns','vibe'), 'img' => esc_url('https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/learningcenter.png')),
                          	'demo_4' => array('' => __('Four Columns','vibe'), 'img' => esc_url('https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/02_preview1.webp')),
                          	       
                          	'default' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/default.jpg')),
                            'demo16' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo16.jpg')),
                            'demo17' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo17.jpg')),
                            'demo15' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo15.jpg')),
                            'demo14' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo14.jpg')),
                            'demo13' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo13.jpg')),
                            
                            'demo11' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo11.jpg')),
                            'demo12' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo12.jpg')),
                            'demo10' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo10.jpg')),
                            'demo9' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo9.jpg')),

							'demo1' => array('Demo1' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo1.jpg')),
							'demo2' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo2.jpg')),
							'demo3' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo3.jpg')),
							'demo4' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo4.jpg')),
							'demo5' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo5.jpg')),
							'demo6' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo6.jpg')),
							'demo7' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo7.jpg')),
							'demo8' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/demo8.jpg')),
							'oneinstructor' => array('One Instructor' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/oneinstructor.jpg')),
							'onecourse' => array('One Course' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/onecourse.jpg')),
							'points_system' => array('Points System' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/points_system.jpg')),
							'childone' => array('Points System' => __('Four Columns','vibe'), 'img' => esc_url('https://wplms.s3.ap-south-1.amazonaws.com/demoswitcher_images/childone.jpg')),  
						),
                    ),
				),
			);
