		...
		public function init_globals() {
			...
			$this->features = array(
								...
								'calendar'=>array(
	                    						...
	                    						'verify'=>array('vibe-calendar/loader.php')
                    						),
	                    		'drive'=>array(
	                    						'label'=>__('Drive','vibe'),
			...
			$this->site_styles = array(
				'instructor' => array(
					'label'=>'Instructor',
					'src' => 'https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/instructor.png',
					'installation_type'=>array('instructor','mooc','academy','university'),
					'link'=>'https://demos.wplms.io/learningcenter/',
					'plugins'=>array('vibebp','wplms_plugin','buddypress','bbpress','vibe-helpdesk','vibe-earnings','vibe-zoom','vibedrive','elementor','woocommerce')
				),
