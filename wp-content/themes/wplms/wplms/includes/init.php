...
class WPLMS_Init{
    ...
    private function __construct(){
        ...
        add_filter( 'wp_check_filetype_and_ext', array($this,'svg_file_and_ext'), 10, 4 );
        add_filter( 'upload_mimes', array($this,'mime_types' ));
    }


    function file_and_ext( $types, $file, $filename, $mimes ) {

        if(empty(vibe_get_option('webp_svg'))){
    ...
    function svg_file_and_ext($data, $file, $filename, $mimes) {
        ...
        <style type="text/css">
            ...
            if(filter_var($url, FILTER_VALIDATE_URL)){
                ...
                body.login div#login h1 a {
                    background-image: url(<?php echo vibe_sanitizer($url,'url'); ?>);
                }
                <?php 
            }
            ?>
            ...
            html,body.login {
                background: <?php echo vibe_sanitizer($dark_bg); ?>;
                }
            body:before{
                content:'';
            ...
            body.login form#loginform label{
                color: <?php echo vibe_sanitizer($dark_color); ?>;
                font-size:11px;
                text-transform: uppercase;
                font-weight:600;
                opacity: 0.8;
            }
            body.login input[type=checkbox]:checked:before{color: <?php echo vibe_sanitizer($dark_color); ?>;}
            body.login.wp-core-ui .button-primary{background:<?php echo vibe_sanitizer($primary_bg); ?>;border:none;box-shadow:none;text-shadow:none;color:<?php echo vibe_sanitizer($primary_color); ?>;}
            body.login form#loginform {
                background:<?php echo vibe_sanitizer($light_bg); ?>;
                box-shadow:none;
                border-radius:2px;
                margin:0;
            }    
            body.login form#loginform label{color:<?php echo vibe_sanitizer($light_color); ?>;}
            ...
            body.login #nav a:hover, body.login #backtoblog a:hover{color:<?php echo vibe_sanitizer($primary_bg); ?>}
            div.error,body.login #login_error{border-radius:2px;}
            <?php
            $wp_login_screen = vibe_get_option('wp_login_screen');
            echo vibe_sanitizer($wp_login_screen);
            ?>
        </style>
        <?php 
        }
...
if(!function_exists('vibe_get_option')){
    function vibe_get_option($field,$compare = NULL){    
        ...
        return apply_filters('vibe_get_option',$wplms->option($field),$field,$compare); 
    }
}
...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.6.3.0.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.4.5.2.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/bbpress.2.6.5.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => 'Vibe Helpdesk', // The plugin name
            'slug'                  => 'vibe-helpdesk', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-helpdesk.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
            'file'                  => 'vibe-helpdesk/loader.php',
        ),
        array(
            'name'                  => 'Layer Slider', // The plugin name
            'slug'                  => 'layerslider', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/layersliderwp.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/revslider.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/js_composer.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/elementor.3.0.10.zip',
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/eventON.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            'name'                  => 'Vibe Calendar', // The plugin name
            'slug'                  => 'vibe-calendar', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-calendar.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
            'file'                  => 'vibe-calendar/loader.php',
        ),
        array(
            'name'                  => 'Vibe Drive', // The plugin name
            'slug'                  => 'vibe-drive', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-drive.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
            'file'                  => 'vibe-drive/loader.php',
        ),
        array(
            'name'                  => 'Vibe Earnings', // The plugin name
            'slug'                  => 'vibe-earnings', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-earnings.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            'name'                  => 'Vibe Zoom', // The plugin name
            'slug'                  => 'vibe-zoom', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-zoom.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            'name'                  => 'Vibe BigBluebutton', // The plugin name
            'slug'                  => 'vibe-bbb', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibe-bbb.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
    ...
    //if($force_activate){
        $plugins[]= array(
            'name'                  => 'WPLMS', // The plugin name
            'slug'                  => 'wplms_plugin', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/wplms_plugin.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        $plugins[]= array(
            'name'                  => 'VibeBP', // The plugin name
            'slug'                  => 'vibebp', // The plugin slug (typically the folder name)
            'source'                => 'https://wplms.io/verify-purchase/?purchase_code='.$purchase_code.'&plugin=wplms.io/vibebp.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
     ...
     */
    $wplms_purchase_code = get_option('wplms_purchase_code');
    $config = array(
        ...
        'strings'           => array(
            'page_title'                                => __( 'Install Required Plugins','vibe' ).(empty($wplms_purchase_code)?' - Warning Missing Purchase Code':''),
            ...
            'notice_can_install_required'               => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.' ,'vibe'), // %1$s = plugin name(s)
            'notice_can_install_recommended'            => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.','vibe' ), // %1$s = plugin name(s)
            'notice_cannot_install'                     => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.','vibe' ), // %1$s = plugin name(s)
            'notice_can_activate_required'              => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.','vibe' ), // %1$s = plugin name(s)
            'notice_can_activate_recommended'           => _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.','vibe' ), // %1$s = plugin name(s)
            'notice_cannot_activate'                    => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.','vibe' ), // %1$s = plugin name(s)
            'notice_ask_to_update'                      => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.','vibe' ), // %1$s = plugin name(s)
            'notice_cannot_update'                      => _n_noop( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.','vibe' ), // %1$s = plugin name(s)
            'install_link'                              => _n_noop( 'Begin installing plugin', 'Begin installing plugins','vibe' ),
            'activate_link'                             => _n_noop( 'Activate installed plugin', 'Activate installed plugins','vibe' ),
